...
MIDDLEWARE_CLASSES = (
    ...
    'matches.middleware.ProfileMiddleware',
...
ROOT_URLCONF = 'diris.urls'

WSGI_APPLICATION = 'diris.wsgi.application'
...
STATICFILES_DIRS = [
    '../diris-app/platforms/browser/www',
    '../diris-app/platforms/android/build/outputs/apk',
]
...
CSP_FRAME_SRC = ("'self'", "www.google.com", "www.youtube.com", "accounts.google.com",
                 "apis.google.com", "plus.google.com")
CSP_SCRIPT_SRC = ("'self'", "*.googleanalytics.com", "*.google-analytics.com",
                  "ajax.googleapis.com")
...
PUBSUB_NOTIFICATIONS_TOPIC = 'notifications'
